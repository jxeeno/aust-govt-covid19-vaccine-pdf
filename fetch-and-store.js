...
const validateData = (data) => {
    const shouldNotBeNullLike = [
        ...
        'doseBreakdown.AUS[3].firstDoseCount',
        'doseBreakdown.AUS[3].firstDosePct',
        'doseBreakdown.AUS[3].secondDoseCount',
        'doseBreakdown.AUS[3].secondDosePct',
        'doseBreakdown.AUS[3].cohortPopulation',

        'doseBreakdown.AUS[4].firstDoseCount',
        'doseBreakdown.AUS[4].firstDosePct',
        // 'doseBreakdown.AUS[4].secondDoseCount',
        // 'doseBreakdown.AUS[4].secondDosePct',
        'doseBreakdown.AUS[4].cohortPopulation',
